...
void main() {
  ...
  float intensity =
    max(c - uBlackPoint, 0.0) * uBrightness;
...
const ctxMap = new WeakMap<HTMLElement, MoltenContext>();
...
const MoltenMetal = ({
    ...
    useEffect(() => {
        ...
        const uc1 =
            u.uColor1.value as Float32Array;

        const uc2 =
            u.uColor2.value as Float32Array;

        const uc3 =
            u.uColor3.value as Float32Array;
