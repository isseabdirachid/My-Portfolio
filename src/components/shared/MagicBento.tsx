...
/* =========================================================
   GLOBAL SPOTLIGHT
   IMPORTANT:
   Waxaa lagu append-gareynayaa MAGIC BENTO scope,
   ma aha document.body.
========================================================= */
...
const GlobalSpotlight: React.FC<{
    ...
    useEffect(() => {
        ...
        /*
         * IMPORTANT:
         * Spotlight wuxuu ku jiraa
         * MagicBento scope.
         *
         * document.body lama isticmaalayo.
         */
        scope.appendChild(
            spotlight
        );
        ...
        /*
         * IMPORTANT:
         * Listener-ku wuxuu ku xiran yahay
         * Bento grid oo keliya.
         *
...
> = ({
    ...
    return (
        <div className="magic-bento-scope">
                        ...
                        const cardContent = (
                            <>
                                ...
                                <div className="magic-bento-card__content">
                                    ...
                                    <span className="magic-bento-card__github">
                                        View on GitHub ↗
                                    </span>
